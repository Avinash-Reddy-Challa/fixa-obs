...
export class VapiService {
  ...
  constructor(private db: PrismaClient) {
    ...
    this.env = {
      VAPI_API_KEY: process.env.VAPI_API_KEY || "26435740-5075-4da2-9a3d-655dcd940dcb", // Your key
      NODE_SERVER_URL:
        process.env.NODE_SERVER_URL || process.env.NEXT_PUBLIC_SERVER_URL || "http://localhost:3000",
    };
